...
export type ChoiceId = { choice_name: ChoiceName; choice_owner: Party };

export const ChoiceId: t.Type<ChoiceId> = t.recursion("ChoiceId", () =>
  t.type({ choice_name: ChoiceName, choice_owner: Party })
);
