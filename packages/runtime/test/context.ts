...
export function getBlockfrostContext () : Context {
    ...
    if (BLOCKFROST_URL == undefined) throw "environment configurations not available (BLOCKFROST_URL)"
    if (BLOCKFROST_PROJECT_ID == undefined) throw "environment configurations not available (BLOCKFROST_PROJECT_ID)"
    if (NETWORK_ID == undefined) throw "environment configurations not available (NETWORK_ID)"
...
export function getBankPrivateKey () : string {
    ...
    if (BANK_PK_HEX == undefined) throw "environment configurations not available (BANK_PK_HEX)"
