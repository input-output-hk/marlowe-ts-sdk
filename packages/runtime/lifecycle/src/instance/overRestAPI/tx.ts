...
import { ContractId, PayoutId, contractIdToTxId, withdrawalIdToTxId } from "@marlowe.io/runtime-core";;
...
export const withdraw
    ...
    = (client) => (wallet) => (payoutIds) =>
        pipe( getAddressesAndCollaterals (wallet)
            ...
            , TE.chainFirstW((withdrawalId) => wallet.waitConfirmation(pipe(withdrawalId, withdrawalIdToTxId)))
            , TE.map (constVoid)) 