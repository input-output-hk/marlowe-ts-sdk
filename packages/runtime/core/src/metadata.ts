...
export const MetadatumRecordGuard: t.Type<MetadatumRecord> = t.recursion(
  "MetadatumRecord",
  () => t.record(MetadatumLabelGuard, MetadatumGuard)
);

export type MetadatumArray = Array<Metadatum>;
export const MetadatumArrayGuard: t.Type<MetadatumArray> = t.recursion(
  "MetadatumArray",
  () => t.array(MetadatumGuard)
);
...
export const MetadataGuard: t.Type<Metadata> = t.record(
  MetadatumTopLevelLabelGuard,
  MetadatumGuard
);
