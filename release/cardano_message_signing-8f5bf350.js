...
export { AlgorithmId, BigNum, CBORArray, CBORObject, CBORSpecial, CBORSpecialType, CBORValue, CBORValueKind, COSEEncrypt, COSEEncrypt0, COSEKey, COSERecipient, COSERecipients, COSESign, COSESign1, COSESign1Builder, COSESignBuilder, COSESignature, COSESignatures, CounterSignature, CurveType, ECKey, EdDSA25519Key, HeaderMap, Headers, Int, KeyOperation, KeyType, Label, LabelKind, Labels, PasswordEncryption, ProtectedHeaderMap, PubKeyEncryption, SigContext, SigStructure, SignedMessage, SignedMessageKind, TaggedCBOR, init as default };
