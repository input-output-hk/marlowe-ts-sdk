...
import { c as commonjsGlobal, g as getDefaultExportFromCjs } from './index-795dd903.js';
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await import('./multipart-parser-36cfd7be.js');
...
export { AbortError, Blob$1 as Blob, FetchError, File$1 as File, FormData, Headers, Request, Response, blobFrom, blobFromSync, fetch as default, fileFrom, fileFromSync, isRedirect };
